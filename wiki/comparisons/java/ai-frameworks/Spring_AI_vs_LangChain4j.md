...
详见 [[entities/java/spring-ai/项目_Spring_AI]] — 项目实体页，含版本、核心能力表、概念对应。
...
Spring AI 的核心架构（来自 [[overview/java/spring-ai/主题_Spring_AI源码架构_综述]]）是典型 Spring 风格：
...
- [[entities/java/spring-ai/项目_Spring_AI]] — Spring AI 项目实体，含核心能力表和概念对应
- [[concepts/java/spring-ai/概念_Spring_AI_架构设计]] — Generic Model 抽象 + ChatClient + Advisor 链架构
- [[overview/java/spring-ai/主题_Spring_AI源码架构_综述]] — Spring AI 源码级主线综述
- [[concepts/java/spring-ai/概念_Spring_AI_设计模式]] — Spring AI 使用的设计模式全景
