...
- [[concepts/ecommerce/mall-swarm/概念_mall-swarm_mall-portal设计]]：修正事务结论并保留前台实现地图。
- [[concepts/ecommerce/mall-swarm/概念_mall-swarm_mall-admin设计]]：后台订单接口、事务与审计记录边界。
- [[concepts/ecommerce/mall-swarm/概念_mall-swarm_mall-gateway设计]]：支付白名单与入口鉴权。
- [[overview/ecommerce/mall-swarm/主题_mall-swarm_架构全景_综述]]：P0 风险优先级。
