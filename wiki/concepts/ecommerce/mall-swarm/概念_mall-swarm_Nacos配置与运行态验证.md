...
- [[overview/ecommerce/mall-swarm/主题_mall-swarm_架构全景_综述]] — 服务全景和本轮 P1 摘要。
- [[concepts/ecommerce/mall-swarm/概念_mall-swarm_认证网关与部署安全]] — Gateway 旁路、管理面和部署安全。
- [[concepts/ecommerce/mall-swarm/概念_mall-swarm_mall-monitor设计]] — Admin Server、Actuator 与日志链路。
- [[concepts/ecommerce/mall-swarm/概念_mall-swarm_订单支付一致性]] — 支付/RabbitMQ 运行态缺口。
