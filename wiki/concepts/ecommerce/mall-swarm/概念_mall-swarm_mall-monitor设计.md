...
- [[concepts/ecommerce/mall-swarm/概念_mall-swarm_Nacos配置与运行态验证]] — P1 配置加载、Nacos/Compose/K8s 运行态边界与只读验证命令。

- [[concepts/ecommerce/mall-swarm/概念_mall-swarm_认证网关与部署安全]]：Monitor NodePort、Actuator 与管理面访问边界的 P0 汇总。
...
- [[overview/java/mall-swarm/主题_mall-swarm_项目入口与模块地图]]
