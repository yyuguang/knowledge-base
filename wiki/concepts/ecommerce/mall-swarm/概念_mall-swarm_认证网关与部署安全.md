...
详见 [[concepts/ecommerce/mall-swarm/概念_mall-swarm_Nacos配置与运行态验证]] 的 Data ID 覆盖、部署差异及只读验证命令；该页要求只核对键、来源与脱敏状态，禁止记录 Secret 值。

## 相关链接

- [[concepts/ecommerce/mall-swarm/概念_mall-swarm_mall-gateway设计]] — 过滤器、路由和异常边界。
- [[concepts/ecommerce/mall-swarm/概念_mall-swarm_mall-auth设计]] — 双身份签发与权限 session。
- [[overview/ecommerce/mall-swarm/主题_mall-swarm_架构全景_综述]] — 服务与部署全景。
