...
sources:
  - "raw/code/spring-ai/spring-ai-model/src/main/java/org/springframework/ai/chat/memory/ChatMemory.java"
  - "raw/code/spring-ai/spring-ai-model/src/main/java/org/springframework/ai/chat/memory/MessageWindowChatMemory.java"
...
- [[concepts/java/spring-ai/概念_Spring_AI_Advisor拦截链]] — MessageChatMemoryAdvisor 在 Advisor 链中自动注入/回填历史
- [[concepts/java/spring-ai/概念_Spring_AI_ToolCalling工具调用]] — ToolCallAdvisor 也需要管理对话历史，与 ChatMemory 协作
- [[concepts/java/spring-ai/概念_Spring_AI_RAG检索增强生成]] — RAG + ChatMemory 实现 "基于历史的检索增强"
- [[concepts/java/spring-ai/概念_Spring_AI_架构设计]] — ChatMemory 是架构中 Model 层的记忆抽象
