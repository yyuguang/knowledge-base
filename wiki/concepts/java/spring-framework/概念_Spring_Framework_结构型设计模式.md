...
- [[concepts/java/spring-framework/概念_Spring_Framework_AOP事务与Web分发]] — AOP 代理和 HandlerAdapter 是结构型模式的核心例子。
- [[concepts/java/spring-framework/概念_Spring_Framework_Web测试消息与应用层扩展]] — ArgumentResolverComposite 位于 MVC 方法调用层。
