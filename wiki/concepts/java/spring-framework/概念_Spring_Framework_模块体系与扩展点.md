...
- [[concepts/java/spring-framework/概念_Spring_Framework_IoC容器启动与Bean生命周期]] — 模块体系的核心执行主线是 `refresh()` 与 Bean 生命周期。
- [[concepts/java/spring-framework/概念_Spring_Framework_AOP事务与Web分发]] — AOP、事务和 Web 展示了运行期扩展点如何工作。
- [[sources/java/spring-framework/来源_Spring_Framework_源码]] — 当前概念来自 Spring Framework 源码模块清单与关键类阅读。
...
- `raw/code/spring-framework/settings.gradle`
- `raw/code/spring-framework/README.md`
- [[sources/java/spring-framework/来源_Spring_Framework_源码]] — 源码入口总览。
