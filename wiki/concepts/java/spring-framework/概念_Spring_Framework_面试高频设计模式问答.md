...
- [[concepts/java/spring-framework/概念_Spring_Framework_创建型设计模式]] — 创建型模式详解。
- [[concepts/java/spring-framework/概念_Spring_Framework_结构型设计模式]] — 结构型模式详解。
- [[concepts/java/spring-framework/概念_Spring_Framework_行为型设计模式]] — 行为型模式详解。
