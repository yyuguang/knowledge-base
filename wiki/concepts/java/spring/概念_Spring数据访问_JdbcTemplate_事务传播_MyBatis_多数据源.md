...
- [[concepts/java/spring-framework/概念_Spring_Framework_数据访问事务同步与集成模块]] — Spring Framework 数据访问源码页。
- [[concepts/java/spring-framework/概念_Spring_Framework_行为型设计模式]] — JdbcTemplate/TransactionTemplate 模板方法。
