...
- [[concepts/agent/概念_BPE分词算法]] — BPE 产生 token IDs，是 Transformer 的输入层
- [[concepts/agent/概念_提示工程]] — Transformer 是提示工程的底层模型
- [[sources/agent/Hello-Agents教程]] — Chapter 3.1 详解 Transformer 的逐步构建
