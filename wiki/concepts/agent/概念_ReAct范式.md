...
- [[concepts/agent/概念_Agent_Loop]] — ReAct 是 Agent Loop 的最经典实现，定义了明确的 Thought-Action 解析规范
- [[concepts/agent/概念_Plan-and-Solve范式]] — 与 ReAct 形成策略对比：边想边做 vs 先规划再执行
- [[concepts/agent/概念_Reflection范式]] — 可在 ReAct 循环后附加反思环节，形成更完整的自我修正链条
