...
- [[concepts/agent/概念_ReAct范式]] — ReAct 是 Agent Loop 最经典的具体实现，显式定义 Thought-Action 解析规范
- [[concepts/agent/概念_PEAS模型]] — PEAS 定义了 Agent Loop 运行的外部环境约束和交互边界
- [[sources/agent/Hello-Agents教程]] — Chapter 1 的完整旅行助手案例演示了 Agent Loop 的端到端实现
