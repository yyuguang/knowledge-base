...
- [[10-domains/ai/agent/概念_ReAct范式]] — Reflection 常叠加在 ReAct 之上，作为每 N 轮的后置反思步骤
- [[10-domains/ai/agent/概念_Agent_Loop]] — Reflection 在标准循环后增加 Critique 环节，形成扩展 Agent Loop
