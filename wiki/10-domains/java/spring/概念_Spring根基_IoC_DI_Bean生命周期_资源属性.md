...
- [[10-domains/java/spring-framework/概念_Spring_Framework_IoC容器启动与Bean生命周期]] — Framework 源码级 Bean 生命周期。
- [[10-domains/java/spring-framework/概念_Spring_Core资源类型注解与转换底座]] — Resource、Environment、ConversionService。
