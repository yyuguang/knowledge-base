...
- [[10-domains/java/spring-framework/概念_Spring_Framework_创建型设计模式]] — FactoryBean 和 Singleton Registry。
- [[10-domains/java/spring-framework/概念_Spring_Framework_行为型设计模式]] — 观察者、回调、责任链。
