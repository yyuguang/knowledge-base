...
- 与 [[10-domains/java/jvm/概念_垃圾收集算法]] 联动：理解堆的划分（新生代/老年代）是分代 GC 的前提
- 与 [[10-domains/java/jvm/概念_Java内存模型JMM]] 联动：主内存对应堆中实例数据，工作内存对应虚拟机栈
...
- [[10-domains/java/jvm/概念_垃圾收集算法]] — 堆内存的分代结构（新生代/老年代）是标记-复制和分代收集理论能够高效运作的前提
- [[10-domains/java/jvm/概念_Java内存模型JMM]] — 主内存对应堆中的实例数据，工作内存对应虚拟机栈，两者共享同一物理内存区域
- [[10-domains/java/jvm/项目_HotSpot_VM]] — 本页描述的是 HotSpot 的实现（合一的本地方法栈、直接指针访问）
