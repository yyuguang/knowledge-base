...
sources:
  ...
  - "raw/sai/spring-ai-rag/src/main/java/org/springframework/ai/rag/"
aliases:
  - RAG
...
- [[10-domains/java/spring-ai/概念_Spring_AI_Advisor拦截链]] — RetrievalAugmentationAdvisor 在 Advisor 链中自动嵌入，before() 执行 7 步流水线
- [[10-domains/java/spring-ai/概念_Spring_AI_ChatClient_API]] — `defaultAdvisors(ragAdvisor)` 注册到 ChatClient
- [[10-domains/java/spring-ai/概念_Spring_AI_架构设计]] — RAG 是架构中 Client-Chat 层的 Advisors 模块之一
- [[10-domains/java/spring-ai/概念_Spring_AI_ChatMemory对话记忆]] — RAG + ChatMemory 组合实现 "基于历史的检索增强"
- [[10-domains/java/spring-ai/概念_Spring_AI_VectorStore向量存储]] — VectorStore 是最常见的 DocumentRetriever 数据源
- [[10-domains/java/spring-ai/主题_Spring_AI源码架构_综述]] — RAG 在完整源码主线中的位置

## 来源

- `raw/sai/spring-ai-rag/src/main/java/org/springframework/ai/rag/advisor/RetrievalAugmentationAdvisor.java`
- `raw/sai/spring-ai-rag/src/main/java/org/springframework/ai/rag/Query.java`
- `raw/sai/spring-ai-rag/src/main/java/org/springframework/ai/rag/retrieval/search/DocumentRetriever.java`
