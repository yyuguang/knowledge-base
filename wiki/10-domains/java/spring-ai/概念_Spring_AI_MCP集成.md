...
sources:
  ...
  - "raw/sai/mcp/common/src/main/java/org/springframework/ai/mcp/McpToolUtils.java"
  - "raw/sai/auto-configurations/mcp/spring-ai-autoconfigure-mcp-client-common/src/main/java/org/springframework/ai/mcp/client/common/autoconfigure/McpClientAutoConfiguration.java"
  - "raw/sai/auto-configurations/mcp/spring-ai-autoconfigure-mcp-client-common/src/main/java/org/springframework/ai/mcp/client/common/autoconfigure/McpToolCallbackAutoConfiguration.java"
  - "raw/sai/mcp/mcp-annotations/src/main/java/org/springframework/ai/mcp/annotation/McpTool.java"
aliases:
  - Spring AI MCP
...
- [[10-domains/java/spring-ai/概念_Spring_AI_ToolCalling工具调用]] — MCP 工具最终会进入 Spring AI ToolCallback / ToolCallingManager 体系。
- [[10-domains/java/spring-ai/概念_Spring_AI_AutoConfiguration自动配置]] — MCP Client、ToolCallbackProvider、transport 都依赖 Boot 自动配置装配。
- [[10-domains/java/spring-ai/概念_Spring_AI_Advisor拦截链]] — ChatClient 使用 MCP 工具时，仍可经由 ToolCallAdvisor 形成 Agent 循环。
