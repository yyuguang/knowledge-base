...
- [[10-domains/java/spring-framework/概念_Spring_Framework_AOP事务与Web分发]] — 本页细化 Web 分发之后的 HandlerAdapter、测试和消息处理。
- [[10-domains/java/spring-framework/概念_Spring_Framework_数据访问事务同步与集成模块]] — Spring Test 的事务测试复用 transaction manager 和事务同步机制。
- [[10-domains/java/spring-framework/概念_Spring_Framework_配置类解析与依赖解析]] — Web/Test/Messaging 策略对象最终都来自 ApplicationContext 中的 Bean。
