...
- [[10-domains/java/spring-framework/概念_Spring_Framework_IoC容器启动与Bean生命周期]] — 创建型模式服务于 BeanDefinition 到 Bean 实例的生命周期。
- [[10-domains/java/spring-framework/概念_Spring_Framework_AOP事务与Web分发]] — AOP 代理创建依赖 `AopProxyFactory`。
- [[10-domains/java/spring-framework/主题_Spring_Framework设计模式_综述]] — 本页属于设计模式第三轮学习的一部分。
