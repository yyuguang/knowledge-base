...
- `application.yml#management.endpoints.web.exposure.include='*'`，且 health/env/configprops 均开放细节/值显示；作为示例服务可以观察配置，但如果被部署到可达网络会暴露敏感运行信息。实际网关白名单与网络边界请参见 [[20-projects/mall-swarm/architecture/概念_mall-swarm_mall-gateway设计]]。
...
- [[20-projects/mall-swarm/architecture/主题_mall-swarm_架构全景_综述]] — 项目服务地图、Gateway 与部署边界。
- [[20-projects/mall-swarm/architecture/概念_mall-swarm_mall-auth设计]] — admin/member Token 签发及 Gateway 鉴权边界。
- [[20-projects/mall-swarm/architecture/概念_mall-swarm_mall-gateway设计]] — `/mall-demo/**` 路由与入口安全规则。
- [[20-projects/mall-swarm/architecture/概念_mall-swarm_mall-common设计]] — `CommonResult` 与全局 MVC 异常处理的公共层边界。
