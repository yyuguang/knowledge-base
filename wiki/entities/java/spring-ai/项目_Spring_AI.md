...
- [[concepts/java/spring-ai/概念_Spring_AI_Advisor拦截链]] — Advisor 链机制、12 个内置 Advisor、自定义扩展
...
- [[concepts/java/spring-ai/概念_Spring_AI_VectorStore向量存储]] — RAG 知识库检索、SearchRequest 和元数据过滤抽象
- [[concepts/java/spring-ai/概念_Spring_AI_AutoConfiguration自动配置]] — Starter 和 Spring Boot 条件装配如何创建核心 Bean
- [[concepts/java/spring-ai/概念_Spring_AI_MCP集成]] — MCP 工具如何接入 Spring AI Tool Calling 体系
- [[sources/java/spring-ai/Spring_AI_源码.md]] — 完整源码分析
